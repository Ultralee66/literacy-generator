...
import { formatVocabularyForPrompt } from "./vocabulary-generator";

/**
 * 根据主题、标题和词汇构建 AI 绘图提示词
 * @param theme 主题/场景（如：超市、医院）
 * @param title 标题（如：走进超市）
 * @param vocabulary 词汇列表
 * @returns 完整的 AI 绘图提示词
 */
export function buildPrompt(
  ...
  const vocabularySection = formatVocabularyForPrompt(vocabulary);
